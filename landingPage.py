...
def get_img_with_href(local_img_path):
    ...
    <div style="display: flex; height: 100vh;">
        ...
        <div class="main-content" style="background-image: url(data:image/{img_format};base64,{bin_str});"></div>
    </div>
    '''
    return html_code
...
def page_co_phieu_chon_loc():
    st.markdown(get_img_with_href(image_url), unsafe_allow_html=True)
